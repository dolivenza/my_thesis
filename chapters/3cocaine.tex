...
%
The rest is metabolised to water-soluble metabolites that can be detected in urine up to 24-36h after consuming the drug or in hair samples potentially up to several weeks later \cite{cone1991testing}. 
%
The metabolites arising from cocaine consumption are: 
benzoylecgonine, 
methylecgonidine,
norcocaine (active), found in hair by \citeauthor{cone1991testing};
cocaethylene (active, metabolises to BZ as well),  found in hair by \citeauthor{cone1991testing};
hydroxycocaines, 
...............


Benzoylecgonine and methylecgonidine (also known as ecgonine methyl ester) are the main metabolites of cocaine, which  are formed when cocaine undergoes deesterification through hydrolysis in the liver \cite{shimomura2019cocaine}.
%
As most cocaine metabolites, benzoylecgonine and methylecgonidine are inactive and hence do not induce any toxicity effects when present in the human body.
%
These two are the metabolites that are normally searched for in urine tests, for whose analysis GC-MS is commonly used, but this technique requires a derivatisation process of the samples prior the chemical analysis: 
...
%
There are also techniques that do not require derivatisation, like HPLC and that developed by  \citeauthor{hezinova2012simultaneous}  
...
Often, cocaine users are heavy drinkers of alcohol. When both cocaine and ethanol are present in the bloodstream, the metabolite cocaethylene is produced in the body, which in itself is a recreational drug with stronger effects than those of cocaine or ethanol individually \cite{mccance1993concurrent}. 
%
The amount of cocaine found in dead bodies when alcohol was certified consumed was lower than in cases where only cocaine was present, indicating that cocaethylene is also deadlier than cocaine
 \cite{lange2001cardiovascular}.

The actual amount of CE produced has been reported to be about one-sixth[27]to one-fifth of the cocaine intake when 
...
Revisar!!!!!!Creo que mal???????????Methyl ecgonine (MeEcg, C$_{10}$H$_{17}$NO$_3$) is the .........From deesterification, hydrolysis in the liver. ESTERASES!!!!!!!!!!!!!!
...
Cocaine is a white solid with a vapour pressure of 2.5$\times$10$^{-7}$ mbar  at 25$^\circ$C, which makes challenging to detect it without any pre-separation system \cite{cocaineVP55}. \citeauthor{RN445} implemented a thermal desorption unit to tackle this low vapour pressure issue for explosives and \citeauthor{blenkhorn2019novel} applied it to the detection of polyaromatic hydrocarbons \cite{RN445,blenkhorn2019novel}.
