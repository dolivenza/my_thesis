...
\usepackage{graphicx}
\usepackage{afterpage}  % load the afterpage package for longtables to start in new page
\usepackage[section]{placeins}  % to have the figures within the section they are using \FloatBarrier

% to look for the char +301 error
...
%%% To find the compiling time in the raw low page by page: timer: time in ms [page]
%\usepackage{atbegshi}
%\newcommand\showtimer{%
...
\usepackage[style=chem-acs,sorting=none,sortcites=true,defernumbers=true,giveninits=true,hyperref,doi=false,eprint=false,url=false,isbn=false,maxnames=1,maxbibnames=99]{biblatex}	%chem-acs, %phys, %nature
