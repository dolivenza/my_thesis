...
\begin{figure}%[h]
\begin{center}
\sidesubfloat[]{\includegraphics[width=0.8\linewidth]{pics/DC_HS1_1000ions.eps}\label{fig:sim_DC}}

\sidesubfloat[]{\includegraphics[width=0.8\linewidth]{pics/RF_HS1_20000ions.eps}\label{fig:sim_RF}}

\sidesubfloat[]{\includegraphics[width=0.8\linewidth]{pics/transmission_p.pdf}\label{fig:current_plot}}
\end{center}
