...
ester branches and an oxygen atom, %in the form of an alcohol molecule, 
...
%
%The MS$^2$ scan for the fragmentation of the MH$^+$ ion in 
The mzCloud database results for diethyl phthalate agree with  PTR-MS %results in \autoref{fig:PH_DEP_fs}
...
The parent ion was not observed either for positive ESI-HCD-MS$^2$ spectra in the mzCloud database for MEHP even at the lowest collisional energies, while negative ESI-HCD-MS$^2$ spectra shows that the deprotonated parent (i.e. \textit{m/z} 277) is the dominant ion up to ca. 11 eV \cite{mzcloudMEHP}.
%
...
%
However, mzCloud also reports protonated phthalic anhydride (i.e. \textit{m/z} 149) and the loss of benzyl alcohol from the protonated parent (i.e. C$_{12}$H$_{13}$O$_3^+$ at \textit{m/z} 205) at the lower collisional energies, but these were not observed in PTR-MS. %the present PTR-MS measurements. 
%
